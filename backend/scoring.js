...
const DEFAULT_WEIGHTS = {
  ...
  'liquid-staking': {
    tvl: 0.50,              // 50% - Total value staked (primary metric)
    fees: 0.25,             // 25% - Protocol fee revenue (sustainability)
    volume: 0.15,           // 15% - Staking/unstaking activity
    tvlGrowth: 0.10         // 10% - TVL growth momentum
  }
};
