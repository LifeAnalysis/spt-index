          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              >
                ...
                <span className="text-label font-medium hidden sm:inline">Dashboard</span>
              </button>
              <div className="h-4 w-px bg-gray-300"></div>
              <h1 className="text-base sm:text-h3 font-bold bg-gradient-to-r from-[#49997E] via-[#5eb896] to-[#49997E] bg-clip-text text-transparent">
                SPT Index
              </h1>
            </div>
          </div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10 sm:mb-12">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-900 mb-4 sm:mb-6 leading-tight">
              ...
              <span className="block mt-2 sm:mt-3 bg-gradient-to-r from-[#49997E] via-blue-600 to-purple-600 bg-clip-text text-transparent">
          ...
          <div className="flex flex-wrap gap-3 justify-center">
            <div className="bg-white px-4 sm:px-6 py-3 rounded-full border-2 border-gray-200 shadow-sm hover:shadow-md transition-shadow">
              <span className="font-semibold text-gray-700 text-sm sm:text-base">📊 Multi-Metric Scoring</span>
            </div>
            <div className="bg-white px-4 sm:px-6 py-3 rounded-full border-2 border-gray-200 shadow-sm hover:shadow-md transition-shadow">
              <span className="font-semibold text-gray-700 text-sm sm:text-base">⚡ Statistical Normalization</span>
            </div>
            <div className="bg-white px-4 sm:px-6 py-3 rounded-full border-2 border-gray-200 shadow-sm hover:shadow-md transition-shadow">
              <span className="font-semibold text-gray-700 text-sm sm:text-base">🎯 100% On-Chain Verified</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid lg:grid-cols-2 gap-6 lg:gap-8 mb-8">
              <div className="bg-gradient-to-br from-red-50 to-orange-50 rounded-2xl p-6 sm:p-8 border-2 border-red-200 shadow-lg hover:shadow-xl transition-shadow">
                <div className="flex items-center gap-3 mb-4 sm:mb-6">
                  <span className="text-3xl sm:text-4xl">❌</span>
                  <h3 className="text-xl sm:text-2xl font-bold text-red-900">Traditional Approach</h3>
                </div>
              ...
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-6 sm:p-8 border-2 border-green-300 shadow-lg hover:shadow-xl transition-shadow">
                <div className="flex items-center gap-3 mb-4 sm:mb-6">
                  <span className="text-3xl sm:text-4xl">✅</span>
                  <h3 className="text-xl sm:text-2xl font-bold text-green-900">SPT Multi-Metric System</h3>
                </div>
                <ul className="space-y-3 sm:space-y-4 text-sm sm:text-base text-gray-800">
                  <li className="flex items-start gap-2">
            ...
            <div className="grid lg:grid-cols-2 gap-4 sm:gap-6">
              <div className="bg-white rounded-xl sm:rounded-2xl p-5 sm:p-6 border-2 border-blue-200 shadow-md hover:shadow-lg transition-shadow">
                <div className="flex items-center gap-2 mb-3">
                  <span className="text-2xl">🔄</span>
                  <span className="font-bold text-blue-900 text-sm sm:text-base">DEX Example</span>
                </div>
              ...
              <div className="bg-white rounded-xl sm:rounded-2xl p-5 sm:p-6 border-2 border-purple-200 shadow-md hover:shadow-lg transition-shadow">
                <div className="flex items-center gap-2 mb-3">
                  <span className="text-2xl">💰</span>
                  <span className="font-bold text-purple-900 text-sm sm:text-base">Lending Example</span>
                </div>
                <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
